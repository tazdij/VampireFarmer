...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ifeq ($(PLATFORM_OS),WINDOWS)
        RAYLIB_RELEASE_PATH = $(RAYLIB_PATH)/release/
    endif
...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ifeq ($(PLATFORM_OS),WINDOWS)
        ...
        #CFLAGS += $(RAYLIB_PATH)/raylib.rc.o
    endif
    ifeq ($(PLATFORM_OS),LINUX)
...
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/release -I$(RAYLIB_PATH)/../src -I$(RAYLIB_PATH)/../src/external
...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ifeq ($(PLATFORM_OS),WINDOWS)
        ...
        LDLIBS = -lraylib_static -lopengl32 -lgdi32
    endif
    ifeq ($(PLATFORM_OS),LINUX)
